namespace NanoRpcSharp.Messages
{
    ...
    public class UncheckedGetTests
    {
        [Fact]
        public void RequestOk()
        {
            var req = new UncheckedGetRequest("87434F8041869A01C8F6F263B87972D7BA443A72E0A97D7A3FD0CCC2358FD6F9");
...
";
            var obj = NanoRpcClient.Deserialize<UncheckedGet>(validJson);
